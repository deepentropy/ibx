//! Fundamental data queries via fundfarm connection (XML-in-FIX tag 6118).
//!
//! Requests use FIX 35=U with 6040=10010, responses arrive as 6040=10012.
//! Response payloads are gzip-compressed XML in FIX tags 95/96.
