//! Scanner subscriptions via ushmds connection (XML-in-FIX tag 6118).
//!
//! Requests use FIX 35=U with sub-protocol tag 6040. XML payloads ride in tag 6118.
//! Scanner parameters use 6040=10001/10002, subscriptions use 10003/10005,
//! cancellations use 10004.

use crate::protocol::fix;

// FIX tags for scanner messages
...
/// Build a FIX 35=U|6040=10001 request for scanner parameters (no XML payload).
...
/// Build the XML payload for a scanner subscription request (tag 6118, 6040=10003).
...
/// Build the XML payload for cancelling a scanner subscription (tag 6118, 6040=10004).
