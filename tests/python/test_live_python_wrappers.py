"""Comprehensive Python wrapper integration tests against live IB paper account.
...
class TestScanner:
    ...
    def test_scanner_parameters(self, ib_connection):
        ...
        if not got_params:
            pytest.skip("No scanner parameters received (HMDS may not be connected)")
...
class TestTickByTick:
    ...
    def test_tbt_last(self, ib_connection):
        ...
        if not got_tbt:
            pytest.skip("No TBT data — market closed or HMDS not streaming")
